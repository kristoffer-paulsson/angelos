...
from angelos.portfolio.domain.accept import AcceptUpdatedDomain
...
class TestAcceptUpdatedEntity(TestCase):
    def test_validate(self):
        ...
        domain = UpdateDomain().perform(ext_portfolio)
        with evaluate("Domain:AcceptUpdate") as r:
            AcceptUpdatedDomain().validate(portfolio, domain)
            print(portfolio)
            print(r.format())