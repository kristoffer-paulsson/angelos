...
def get_key(args, generate=False):
    ...
    msg = '\nArchives are encrypted and a key is ' \
...
def file_size(size):
    ...
    return '{:<5.4g} {:}'.format(size / (1 << (order * 10)), SUFFIXES[order])
