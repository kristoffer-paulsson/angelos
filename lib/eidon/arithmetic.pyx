...
#
# Adapted to Python 3 only, flake8-compliant
...
class ArithmeticCoderBase(object):
    ...
    def __init__(self, numbits):
        ...
        # Maximum range (high+1-low) during coding (trivial), which is 2^num_state_bits = 1000...000.  # noqa E501
        ...
        # The second highest bit at width num_state_bits, which is 0010...000. This is zero when num_state_bits=1.  # noqa E501
        self.quarter_range = self.half_range >> 1  # Can be zero
        # Minimum range (high+1-low) during coding (non-trivial), which is 0010...010.  # noqa E501
        self.minimum_range = self.quarter_range + 2  # At least 2
        # Maximum allowed total from a frequency table at all times during coding. This differs from Java  # noqa E501
        # and C++ because Python's native bigint avoids constraining the size of intermediate computations.  # noqa E501
        self.maximum_total = self.minimum_range
        # Bit mask of num_state_bits ones, which is 0111...111.
        self.state_mask = self.full_range - 1

        # -- State fields --
        # Low end of this arithmetic coder's current range. Conceptually has an infinite number of trailing 0s.  # noqa E501
        self.low = 0
        # High end of this arithmetic coder's current range. Conceptually has an infinite number of trailing 1s.  # noqa E501
    ...
    def update(self, freqs, symbol):
        ...
        # While low's top two bits are 01 and high's are 10, delete the second highest bit of both  # noqa E501
...
class ArithmeticDecoder(ArithmeticCoderBase):
    ...
    def __init__(self, numbits, bitin):
        ...
        self.input = bitin
        # The current raw code bits being buffered, which is always in the range [low, high].  # noqa E501
        self.code = 0
    ...
    def read(self, freqs):
        ...
        # A kind of binary search. Find highest symbol such that freqs.get_low(symbol) <= value.  # noqa E501
        start = 0
...
class SimpleFrequencyTable(FrequencyTable):
    ...
    def __init__(self, freqs):
        ...
        # cumulative[i] is the sum of 'frequencies' from 0 (inclusive) to i (exclusive).  # noqa E501
...
class BitInputStream(object):
    ...
    def __init__(self, inp):
        ...
        self.input = inp
        # Either in the range [0x00, 0xFF] if bits are available, or -1 if end of stream is reached  # noqa E501
        self.currentbyte = 0
        # Number of remaining bits in the current byte, always between 0 and 7 (inclusive)  # noqa E501
...
class BitOutputStream(object):
    ...
    def __init__(self, out):
        ...
        self.output = out
        # The accumulated bits for the current byte, always in the range [0x00, 0xFF]  # noqa E501
        self.currentbyte = 0
        # Number of accumulated bits in the current byte, always between 0 and 7 (inclusive)  # noqa E501
