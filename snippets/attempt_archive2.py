...
archive = Archive.create(
    path='./test.ar7.cnl',
    owner=uuid.UUID(bytes=b'\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x00'),
...
archive = Archive.open(path='./test.ar7.cnl', secret=base64.b64decode(secret))
